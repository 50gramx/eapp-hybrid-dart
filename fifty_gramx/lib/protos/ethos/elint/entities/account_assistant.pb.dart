...
class AccountAssistant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountAssistant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'elint.entity'), createEmptyInstance: create)
    ...
    ..aOM<$19.Account>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'account', subBuilder: $19.Account.create)
  ...
  @$pb.TagNumber(4)
  $19.Account get account => $_getN(3);
  @$pb.TagNumber(4)
  set account($19.Account v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAccount() => $_has(3);
  @$pb.TagNumber(4)
  void clearAccount() => clearField(4);
  @$pb.TagNumber(4)
  $19.Account ensureAccount() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $52.Timestamp get lastAssistedAt => $_getN(5);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $52.Timestamp ensureLastAssistedAt() => $_ensure(5);
}
