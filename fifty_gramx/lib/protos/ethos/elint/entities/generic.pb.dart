...
class PersistentSessionTokenDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PersistentSessionTokenDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'elint.entity'), createEmptyInstance: create)
    ...
    ..aOM<$52.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'generatedAt', subBuilder: $52.Timestamp.create)
    ..aOM<$52.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastUsedAt', subBuilder: $52.Timestamp.create)
    ..aOM<$52.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validTill', subBuilder: $52.Timestamp.create)
  ...
  factory PersistentSessionTokenDetails({
    ...
    $52.Timestamp? generatedAt,
    $52.Timestamp? lastUsedAt,
    $52.Timestamp? validTill,
  }) {
  ...
  @$pb.TagNumber(3)
  $52.Timestamp get generatedAt => $_getN(2);
  @$pb.TagNumber(3)
  set generatedAt($52.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasGeneratedAt() => $_has(2);
  @$pb.TagNumber(3)
  void clearGeneratedAt() => clearField(3);
  @$pb.TagNumber(3)
  $52.Timestamp ensureGeneratedAt() => $_ensure(2);

  @$pb.TagNumber(4)
  $52.Timestamp get lastUsedAt => $_getN(3);
  @$pb.TagNumber(4)
  set lastUsedAt($52.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLastUsedAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearLastUsedAt() => clearField(4);
  @$pb.TagNumber(4)
  $52.Timestamp ensureLastUsedAt() => $_ensure(3);

  @$pb.TagNumber(5)
  $52.Timestamp get validTill => $_getN(4);
  @$pb.TagNumber(5)
  set validTill($52.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasValidTill() => $_has(4);
  @$pb.TagNumber(5)
  void clearValidTill() => clearField(5);
  @$pb.TagNumber(5)
  $52.Timestamp ensureValidTill() => $_ensure(4);
}
...
class TemporarySessionTokenDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TemporarySessionTokenDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'elint.entity'), createEmptyInstance: create)
    ...
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sessionScope')
    ..aOM<$52.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'generatedAt', subBuilder: $52.Timestamp.create)
    ..aOM<$52.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validTill', subBuilder: $52.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $52.Timestamp get validTill => $_getN(3);
  @$pb.TagNumber(4)
  set validTill($52.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasValidTill() => $_has(3);
  @$pb.TagNumber(4)
  void clearValidTill() => clearField(4);
  @$pb.TagNumber(4)
  $52.Timestamp ensureValidTill() => $_ensure(3);
}
...
class PersistentTokenDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PersistentTokenDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'elint.entity'), createEmptyInstance: create)
    ...
    ..aOM<$52.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'generatedAt', subBuilder: $52.Timestamp.create)
    ..aOM<$52.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastUsedAt', subBuilder: $52.Timestamp.create)
    ..aOM<$52.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validTill', subBuilder: $52.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $52.Timestamp get generatedAt => $_getN(1);
  @$pb.TagNumber(2)
  set generatedAt($52.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasGeneratedAt() => $_has(1);
  @$pb.TagNumber(2)
  void clearGeneratedAt() => clearField(2);
  @$pb.TagNumber(2)
  $52.Timestamp ensureGeneratedAt() => $_ensure(1);

  @$pb.TagNumber(3)
  $52.Timestamp get lastUsedAt => $_getN(2);
  @$pb.TagNumber(3)
  set lastUsedAt($52.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLastUsedAt() => $_has(2);
  @$pb.TagNumber(3)
  void clearLastUsedAt() => clearField(3);
  @$pb.TagNumber(3)
  $52.Timestamp ensureLastUsedAt() => $_ensure(2);
...
class TemporaryTokenDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TemporaryTokenDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'elint.entity'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'token')
    ..aOM<$52.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'generatedAt', subBuilder: $52.Timestamp.create)
    ..aOM<$52.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validTill', subBuilder: $52.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $52.Timestamp get validTill => $_getN(2);
  @$pb.TagNumber(3)
  set validTill($52.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasValidTill() => $_has(2);
  @$pb.TagNumber(3)
  void clearValidTill() => clearField(3);
  @$pb.TagNumber(3)
  $52.Timestamp ensureValidTill() => $_ensure(2);
}
