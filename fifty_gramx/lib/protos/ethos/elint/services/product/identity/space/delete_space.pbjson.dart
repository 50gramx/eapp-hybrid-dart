...
const DeleteSpaceRequest$json = const {
  '1': 'DeleteSpaceRequest',
};

/// Descriptor for `DeleteSpaceRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteSpaceRequestDescriptor = $convert.base64Decode('ChJEZWxldGVTcGFjZVJlcXVlc3Q=');
@$core.Deprecated('Use deleteSpaceResponseDescriptor instead')
const DeleteSpaceResponse$json = const {
  '1': 'DeleteSpaceResponse',
};

/// Descriptor for `DeleteSpaceResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteSpaceResponseDescriptor = $convert.base64Decode('ChNEZWxldGVTcGFjZVJlc3BvbnNl');
