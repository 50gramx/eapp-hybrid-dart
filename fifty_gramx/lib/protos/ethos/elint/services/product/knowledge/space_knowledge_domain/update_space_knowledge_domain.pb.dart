...
class UpdateSpaceKnowledgeDomainNameRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateSpaceKnowledgeDomainNameRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'elint.services.product.knowledge.domain'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  UpdateSpaceKnowledgeDomainNameRequest copyWith(void Function(UpdateSpaceKnowledgeDomainNameRequest) updates) => super.copyWith((message) => updates(message as UpdateSpaceKnowledgeDomainNameRequest)) as UpdateSpaceKnowledgeDomainNameRequest; // ignore: deprecated_member_use
...
class UpdateSpaceKnowledgeDomainNameResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateSpaceKnowledgeDomainNameResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'elint.services.product.knowledge.domain'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateSpaceKnowledgeDomainNameResponse copyWith(void Function(UpdateSpaceKnowledgeDomainNameResponse) updates) => super.copyWith((message) => updates(message as UpdateSpaceKnowledgeDomainNameResponse)) as UpdateSpaceKnowledgeDomainNameResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
