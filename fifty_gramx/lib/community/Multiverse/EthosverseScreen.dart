...
class EthosverseScreen extends StatelessWidget {
  const EthosverseScreen();
  ...
  Widget build(BuildContext context) {
    return NeumorphicApp(
      ...
      routes: {
        '/': (context) => const EthosversePage(),
      },
    );
  }
}

class EthosversePage extends StatelessWidget {
  const EthosversePage();
          ...
          slivers: <Widget>[
            ...
            SliverList(
              ...
              Container(
                  ...
                  child: FormInfoText("UNIVERSE").build(context)),
