...
class PlanPageConfig {
  ...
  Widget buildPage(BuildContext context) {
    final List<Widget Function(BuildContext)> _sections = [
      (context) => buildPlansSection(context),
      (context) => buildComparisonSection(context),
    ];
  ...
  Widget buildComparisonSection(BuildContext context) {
    final bool isMobile = !LayoutBreakpoint().isNavigatingLeft(context);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        SizedBox(height: 64),
