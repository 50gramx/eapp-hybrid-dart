...
import 'package:fifty_gramx/community/onboarding/website/collars_pages/53/offer-letter-closed-isolated-skd-collar/overview_page/overview_page_sliver_body.dart';
...
class OfferLetterCISKDCOverviewPage extends StatefulWidget {
  const OfferLetterCISKDCOverviewPage({Key? key}) : super(key: key);

  @override
  State<OfferLetterCISKDCOverviewPage> createState() =>
      _OfferLetterCISKDCOverviewPageState();
}

class _OfferLetterCISKDCOverviewPageState
    extends State<OfferLetterCISKDCOverviewPage> {
  @override
  void initState() {
