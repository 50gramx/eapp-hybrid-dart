...
class _HomePageState extends State<HomePage> {
  List<SpaceKnowledgeDomain> ethosKnowledgeDomains = [
    ...
    SpaceKnowledgeDomain(
      ...
      spaceKnowledgeDomainDescription: "Sendil is your dedicated digital real estate assistant, designed to streamline and simplify the property prospecting and onboarding process in Indiranagar, Bangalore. With Sendil, you'll experience hassle-free property search, inquiries, and visit scheduling, saving you and your clients valuable time.",
    ),
    SpaceKnowledgeDomain(
  ...
  Widget build(BuildContext context) {
    ...
    var drawer = isNavigatingLeft ? null : Drawer(
        child: ListView(
    ...
    Widget mainColumn = Flexible(child: Column(children: [expandedDomainList],), flex: 7,);
    Widget expandedColumn = isNavigatingLeft ? Flexible(child: Column(children: [],), flex: 3,) : SizedBox();
    Widget mainRow = Row(children: [
      mainColumn,
      expandedColumn,
    ],);
    return Scaffold(
