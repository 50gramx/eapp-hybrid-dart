...
class KubectlNamespacedConfigMapResources {
  /// contains the base command for resource management commands
  static String _baseCommandSpace = "";

  // initialises the class
  KubectlNamespacedConfigMapResources(String baseCommandSpace) {
  ...
  Future<bool> multiverseIngressController() async {
    ...
    String assetPath =
        "lib/community/apps/gramx/seventy/zero/ethos/pods/configurations/multiverse/resources/namespaced/ingress-nginx-controller-config-map.yaml";
