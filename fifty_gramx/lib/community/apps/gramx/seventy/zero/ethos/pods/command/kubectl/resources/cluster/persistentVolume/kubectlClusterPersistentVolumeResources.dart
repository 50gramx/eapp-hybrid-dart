...
class KubectlClusterPersistentVolumeResources {
  /// contains the base command for resource management commands
  static String _baseCommandSpace = "";

  // initialises the class
  KubectlClusterPersistentVolumeResources(String baseCommandSpace) {
    _baseCommandSpace = baseCommandSpace;
  }

  /// creates the resource for "multiverse-file-system-persistent-volume"
  ///
  ...
  Future<bool> multiverseFileSystem() async {
    ...
    String assetPath =
        "lib/community/apps/gramx/seventy/zero/ethos/pods/configurations/multiverse/resources/cluster/multiverse-filesystem-persistent-volume.yaml";
