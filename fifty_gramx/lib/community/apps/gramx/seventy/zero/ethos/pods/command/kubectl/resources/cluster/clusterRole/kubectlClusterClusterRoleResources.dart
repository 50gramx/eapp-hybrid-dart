...
class KubectlClusterClusterRoleResources {
  /// contains the base command for resource management commands
  static String _baseCommandSpace = "";

  // initialises the class
  KubectlClusterClusterRoleResources(String baseCommandSpace) {
  ...
  Future<bool> multiverseIngressAdmission() async {
    ...
    String assetPath =
        "lib/community/apps/gramx/seventy/zero/ethos/pods/configurations/multiverse/resources/cluster/ingress-nginx-admission-cluster-role.yaml";
  ...
  Future<bool> multiverseIngressController() async {
    // fetch the temporary path for configuration file from the assets
    String assetPath =
        "lib/community/apps/gramx/seventy/zero/ethos/pods/configurations/multiverse/resources/cluster/ingress-nginx-controller-cluster-role.yaml";
    // transfer the asset to vm
    String vmAssetPath = await MultipassCommands.transfer.asset(assetPath);
    // build the command
    String command = "$_baseCommandSpace -f $vmAssetPath";
