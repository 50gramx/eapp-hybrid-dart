...
class Space extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Space', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'elint.entity'), createEmptyInstance: create)
    ..aOM<$54.Galaxy>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'galaxy', subBuilder: $54.Galaxy.create)
    ...
    ..aOM<$52.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'spaceCreatedAt', subBuilder: $52.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $54.Galaxy get galaxy => $_getN(0);
  @$pb.TagNumber(1)
  set galaxy($54.Galaxy v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasGalaxy() => $_has(0);
  @$pb.TagNumber(1)
  void clearGalaxy() => clearField(1);
  @$pb.TagNumber(1)
  $54.Galaxy ensureGalaxy() => $_ensure(0);
  ...
  @$pb.TagNumber(7)
  $52.Timestamp get spaceCreatedAt => $_getN(6);
  @$pb.TagNumber(7)
  set spaceCreatedAt($52.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasSpaceCreatedAt() => $_has(6);
  @$pb.TagNumber(7)
  void clearSpaceCreatedAt() => clearField(7);
  @$pb.TagNumber(7)
  $52.Timestamp ensureSpaceCreatedAt() => $_ensure(6);
}
