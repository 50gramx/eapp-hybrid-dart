...
const DeleteSpaceKnowledgeDomainRequest$json = const {
...
final $typed_data.Uint8List deleteSpaceKnowledgeDomainRequestDescriptor = $convert.base64Decode('CiFEZWxldGVTcGFjZUtub3dsZWRnZURvbWFpblJlcXVlc3Q=');
@$core.Deprecated('Use deleteSpaceKnowledgeDomainResponseDescriptor instead')
const DeleteSpaceKnowledgeDomainResponse$json = const {
...
final $typed_data.Uint8List deleteSpaceKnowledgeDomainResponseDescriptor = $convert.base64Decode('CiJEZWxldGVTcGFjZUtub3dsZWRnZURvbWFpblJlc3BvbnNl');
